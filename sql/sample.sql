...
INSERT INTO funders.payments VALUES ('3891fb08-f548-428c-80dc-e02f27ca2bdf', 31337, 31337, 'credit_card', 'Donovan James', 'Donovan James', '12 East Tremont Avenue', DEFAULT, 'Bronx', '10467', 'USA', 25, 'USD', 'success', DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, 'stripe', current_timestamp, current_timestamp);
INSERT INTO funders.payments VALUES ('0a245453-67fc-4ecb-a89a-f6e0ca393804', 31337, 31337, 'credit_card', 'Donovan James', 'Donovan James', '12 East Tremont Avenue', DEFAULT, 'Bronx', '10467', 'USA', 25, 'USD', 'success', DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, 'stripe', current_timestamp, current_timestamp);
INSERT INTO funders.payments VALUES ('5d5e0c4b-157f-467f-ae0d-bf699143a2f4', 31337, 31340, 'credit_card', 'Donovan James', 'Donovan James', '12 East Tremont Avenue', DEFAULT, 'Bronx', '10467', 'USA', 500, 'USD', 'success', DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, 'stripe', current_timestamp, current_timestamp);
